...
TEST_CASE("Test PopBack method")
{
	...
	MyList<std::string> list;
	REQUIRE(list.IsEmpty());
	// добавить проверку Pop пустого списка
...
TEST_CASE("Test iterator increment operator")
{
	...
	{
		MyList<std::string>::ConstIterator iterator = list.begin();
	...
	{
		MyList<std::string>::ConstIterator iterator = list.end();
	...
	{
		MyList<std::string>::ConstReverseIterator iterator = list.rend();
...
TEST_CASE("Test iterator decrement operator")
{
	...
	{
		MyList<std::string>::ConstReverseIterator iterator = list.rbegin();
...
TEST_CASE("Test regular const and non-const iterator")
{
	...
	{
		MyList<std::string>::Iterator iterator = list.begin();
...
TEST_CASE("Test reverse const and non-const iterator")
{
	...
	{
		MyList<std::string>::ReverseIterator iterator = list.rbegin();
...
{
	MyList<std::string>::ConstIterator iterator;
